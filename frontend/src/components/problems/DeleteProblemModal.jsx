...
const DeleteProblemModal = ({ isOpen, onClose, onConfirm, problemTitle }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          <div className="p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Delete Problem</h3>
            <p className="text-gray-500 mb-1">Are you sure you want to delete</p>
            <p className="text-gray-900 font-semibold mb-6 break-words">"{problemTitle}"?</p>
            <p className="text-sm text-red-500 mb-6 bg-red-50 p-3 rounded-lg border border-red-100">
              This action cannot be undone. All student submissions and analytics for this problem will be lost.
            </p>
