...
const DeleteAssignmentModal = ({ isOpen, onClose, onConfirm, assignmentTitle }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          <div className="p-6">
            ...
            <p className="text-gray-900 font-semibold mb-6 break-words">"{assignmentTitle}"?</p>
            <p className="text-sm text-red-500 mb-6 bg-red-50 p-3 rounded-lg border border-red-100">
              This action cannot be undone. All student submissions and evaluations will be lost.
            </p>
